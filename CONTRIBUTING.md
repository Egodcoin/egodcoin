Contributing to Egodcoin Core
============================

The Egodcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/The-Egodcoin-Endeavor/egodcoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Egodcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Egodcoin
Network Protocol consensus changes.

Whether a pull request is merged into Egodcoin Core rests with the project merge
...
Patches that change Egodcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Egodcoin consensus, it must have been
...
The review process is normally fairly responsive on the Egodcoin Core repository, however
...
The project leader is the release manager for each Egodcoin Core release.
