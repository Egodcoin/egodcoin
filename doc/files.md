...
* egodcoin.conf: contains configuration settings for egodcoind or egodcoin-qt
* egodcoind.pid: stores the process id of egodcoind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by egodcoind or egodcoin-qt
