...
This mechanism has been integrated into Egodcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/egodcoin/insight-api-egodcoin#web-socket-api](https://github.com/egodcoin/insight-api-egodcoin#web-socket-api)
* API: [https://github.com/egodcoin/insight-api-egodcoin#instantsend-transactions](https://github.com/egodcoin/insight-api-egodcoin#instantsend-transactions)
