...
official/supported Docker Images found at https://hub.docker.com/r/Egodcoin/egodcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/Egodcoin/egodcoind-develop/ when changing the above text**