...
#ifndef EGODCOIN_ARITH_UINT256_H
#define EGODCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Egodcoin only uses this "compact" format for encoding difficulty
...
#endif // EGODCOIN_ARITH_UINT256_H
