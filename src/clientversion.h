...
#error Client version information missing: version is not defined by egodcoin-config.h or in any other way
#endif
...
/**
 * egodcoind-res.rc includes this file, but it cannot cope with real c++ code.
