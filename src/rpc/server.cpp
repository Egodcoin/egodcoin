...
CAmount AmountFromValue(const UniValue& value, bool p_isEGOD)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Egodcoin Core server stopping";
}
...
{
    return "> egodcoin-cli " + methodname + " " + args + "\n";
}
