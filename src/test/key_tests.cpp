...
BOOST_AUTO_TEST_CASE(key_test1)
{
    ...
    for (int n=0; n<16; n++)
    {
        ...
        BOOST_CHECK(key1.SignSecp256k1 (hashMsg, sign1));
        BOOST_CHECK(key2.SignSecp256k1 (hashMsg, sign2));
        BOOST_CHECK(key1C.SignSecp256k1(hashMsg, sign1C));
        BOOST_CHECK(key2C.SignSecp256k1(hashMsg, sign2C));
    ...
    uint256 hashMsg = Hash(strMsg.begin(), strMsg.end());
    BOOST_CHECK(key1.SignSecp256k1(hashMsg, detsig));
    BOOST_CHECK(key1C.SignSecp256k1(hashMsg, detsigc));
    BOOST_CHECK(detsig == detsigc);
    BOOST_CHECK(detsig == ParseHex("304402205dbbddda71772d95ce91cd2d14b592cfbc1dd0aabd6a394b6c2d377bbe59d31d022014ddda21494a4e221f0824f0b8b924c43fa43c0ad57dccdaa11f81a6bd4582f6"));
    BOOST_CHECK(key2.SignSecp256k1(hashMsg, detsig));
    BOOST_CHECK(key2C.SignSecp256k1(hashMsg, detsigc));
    BOOST_CHECK(detsig == detsigc);
