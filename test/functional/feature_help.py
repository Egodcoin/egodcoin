...
"""Verify that starting egodcoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start egodcoind with -h for help text")
        ...
        self.log.info("Start egodcoind with -version for version information")
