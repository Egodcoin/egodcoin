...
rm -f src/config/egodcoin-config.h
...
rm -rf test_bitcoin.coverage/ egodcoin-gtest.coverage/ total.coverage/
...
clean_exe src/egodcoin-cli
clean_exe src/egodcoind
clean_exe src/egodcoin-gtest
clean_exe src/egodcoin-tx
clean_exe src/test/test_egodcoin
clean_exe src/test/test_egodcoin_fuzzy
...
clean_dep . src/config/egodcoind-config.h.in
